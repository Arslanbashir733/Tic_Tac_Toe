...
public class MultiIPlayerEasyActivity extends AppCompatActivity implements View.OnClickListener {

    private int dimention = 3;
    private Button[][] Button = new Button[dimention][dimention];
       ...
       Button back = findViewById(R.id.back);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(MultiIPlayerEasyActivity.this, MultiPlayerLevelsActivity.class));
            }
        });
    }
